deps="cairo-2 png16-16 jpeg-8 pango-1.0-0 pangocairo-1.0-0 gobject-2.0-0 glib-2.0-0 turbojpeg-0 gif-7 freetype-6 rsvg-2-2 pixman-1-0";
...
pacman --noconfirm --needed -S \
  ...
  mingw64/mingw-w64-x86_64-pixman
